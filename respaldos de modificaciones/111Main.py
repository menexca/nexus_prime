...
class LoginDialog(QDialog):
    ...
    def init_ui(self):
        ...
        btn.setAutoDefault(False) # Evita que capture el Enter automáticamente
        btn.setDefault(False)     # Le quita el título de "Botón por defecto"
...
if __name__ == "__main__":
    ...
    if login.exec() == QDialog.DialogCode.Accepted:
        ...
        #menu.show()
        menu.showMaximized() # maximiza la ventana del menu
